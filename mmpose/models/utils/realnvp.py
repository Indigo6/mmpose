...
class RealNVP(nn.Module):
    ...
    def forward_p(self, z):
        # x=z*beta+gamma, refer: https://www.youtube.com/watch?v=uXY18nzdSsM
        x = z
    ...
    def backward_p(self, x):
        # refer: https: // www.youtube.com / watch?v = uXY18nzdSsM
        ...
        for i in reversed(range(len(self.t))):
            ...
            # log[det(J_G)] = sum of log(beta) = sum of s,
            # and we need log[det(J_{G^-1})] = log[1/det(J_G)] = - sum of s
